...
\phantomsection
\section*{Kasutatud allikad}
\addcontentsline{toc}{section}{Kasutatud allikad}

\begin{itemize}
   \item[] Redditi kogukond r/selfhosted [\url{https://www.reddit.com/r/selfhosted/}]
   \item[] Tailscale [\url{https://tailscale.com/}]
   \item[] CGNAT [\url{https://en.wikipedia.org/wiki/Carrier-grade_NAT}]
   \item[] Dynamic DNS [\url{https://en.wikipedia.org/wiki/Dynamic_DNS}]
   \item[] Tailscale'i dokumendid: control data planes [\url{https://tailscale.com/docs/concepts/control-data-planes}]
   \item[] Tailscale'i dokumendid: tailnet [\url{https://tailscale.com/docs/concepts/tailnet}]
   \item[] Tailscale'i blogi: NAT traversal [\url{https://tailscale.com/blog/how-nat-traversal-works}]
   \item[] Mesh VPN / mesh-võrgustik [\url{https://en.wikipedia.org/wiki/Mesh_networking}]
   \item[] Radmin VPN [\url{https://www.radmin-vpn.com/}]
   \item[] Self-hosting [\url{https://en.wikipedia.org/wiki/Self-hosting_(network)}]
   \item[] Syncthing [\url{https://syncthing.net/}]
   \item[] Yggdrasil [\url{https://yggdrasil-network.github.io/}]
   \item[] BitTorrent [\url{https://en.wikipedia.org/wiki/BitTorrent}]
   \item[] BitTorrenti tracker [\url{https://en.wikipedia.org/wiki/BitTorrent_tracker}]
   \item[] BitTorrenti kliendid [\url{https://en.wikipedia.org/wiki/Comparison_of_BitTorrent_clients}]
   \item[] Kademlia [\url{https://en.wikipedia.org/wiki/Kademlia}]
   \item[] DHT ehk hajustabel [\url{https://en.wikipedia.org/wiki/Distributed_hash_table}]
   \item[] Mainline DHT [\url{https://en.wikipedia.org/wiki/Mainline_DHT}]
   \item[] Video: Kademlia, Explained [\url{https://www.youtube.com/watch?v=1QdKhNpsj8M}]
   \item[] Radicle [\url{https://radicle.xyz/}]
   \item[] Git [\url{https://en.wikipedia.org/wiki/Git}]
   \item[] Forge-platvormid [\url{https://en.wikipedia.org/wiki/Forge_(software)}]
   \item[] GitHub [\url{https://github.com/}]
   \item[] GitLab [\url{https://about.gitlab.com/}]
   \item[] Radicle Heartwood [\url{https://app.radicle.xyz/nodes/iris.radicle.xyz/rad%3Az3gqcJUoA1n9HaHKufZs5FCSGazv5}]
   \item[] Radicle'i protokollidokumentatsioon [\url{https://radicle.xyz/guides/protocol}]
   \item[] Video: iroh [\url{https://www.youtube.com/watch?v=RwAt36Xe3UI}]
   \item[] Rust [\url{https://rust-lang.org/}]
   \item[] NAT hole punching [\url{https://en.wikipedia.org/wiki/UDP_hole_punching}]
   \item[] Redditi arutelu võrgu teemal [\url{https://www.reddit.com/r/networking/comments/a8c42z/}]
   \item[] Koormuse- ja kiiruse juhtimine [\url{https://en.wikipedia.org/wiki/Network_congestion#Congestion_control}]
   \item[] Ed25519 [\url{https://en.wikipedia.org/wiki/EdDSA#Ed25519}]
   \item[] ChaCha20-Poly1305 [\url{https://en.wikipedia.org/wiki/ChaCha20-Poly1305}]
   \item[] BLAKE3 [\url{https://en.wikipedia.org/wiki/BLAKE_(hash_function)}]
   \item[] SHA-2 [\url{https://en.wikipedia.org/wiki/SHA-2}]
   \item[] Rusti UDP socketi dokumentatsioon [\url{https://doc.rust-lang.org/std/net/struct.UdpSocket.html}]
   \item[] Paisktabel [\url{https://en.wikipedia.org/wiki/Hash_table}]
   \item[] Kommit 5a66b3 [\url{https://github.com/dankmolot/petope/tree/5a66b32a015f395bc614a1aedc54a87a44d8dbc1}]
   \item[] netcat [\url{https://en.wikipedia.org/wiki/Netcat}]
   \item[] Termux [\url{https://termux.dev/en/}]
   \item[] Hetzner [\url{https://www.hetzner.com/}]
   \item[] Zeroconf [\url{https://en.wikipedia.org/wiki/Zero-configuration_networking}]
   \item[] Iroh: local discovery [\url{https://docs.iroh.computer/connecting/local-discovery}]
   \item[] TCP hole punching [\url{https://en.wikipedia.org/wiki/TCP_hole_punching}]
   \item[] socket2 [\url{https://crates.io/crates/socket2}]
   \item[] Võrgupesa [\url{https://en.wikipedia.org/wiki/Network_socket}]
   \item[] Kommit 3e83b3 [\url{https://github.com/dankmolot/petope/tree/3e83b3}]
   \item[] Loopback [\url{https://en.wikipedia.org/wiki/Loopback}]
   \item[] Tokio [\url{https://tokio.rs/}]
   \item[] Tokio juhend [\url{https://tokio.rs/tokio/tutorial}]
   \item[] mini-redis [\url{https://github.com/tokio-rs/mini-redis/}]
   \item[] Framing [\url{https://en.wikipedia.org/wiki/Frame_(networking)}]
   \item[] Kommit c46a8e [\url{https://github.com/dankmolot/petope/tree/c46a8e7b36c998d946180e0317b63daccaaf1a2a}]
   \item[] NAT hairpinning [\url{https://en.wikipedia.org/wiki/Network_address_translation#NAT_hairpinning}]
   \item[] ASUS-e dokumentatsioon [\url{https://www.asus.com/support/faq/1043024/}]
   \item[] Foorumiarutelu NAT loopbacki kohta [\url{https://www.snbforums.com/threads/asus-ac86u-firmware-merlin-386-11-nat-loopback-not-working-please-help.85974/}]
   \item[] Teenuseavastus [\url{https://en.wikipedia.org/wiki/Service_discovery}]
   \item[] Multicast DNS (mDNS) [\url{https://en.wikipedia.org/wiki/Multicast_DNS}]
   \item[] mdns-sd [\url{https://crates.io/crates/mdns-sd}]
   \item[] Kommit 0915f0 [\url{https://github.com/dankmolot/petope/tree/0915f06ad2b44db91ace9968bc6654252927c25b}]
   \item[] Minimum viable product [\url{https://en.wikipedia.org/wiki/Minimum_viable_product}]
   \item[] Kommit 161ffc [\url{https://github.com/dankmolot/petope/tree/161ffc0ae3fbb76fd88bc4d2ecf82507cd16596b}]
   \item[] Avaliku võtmega krüptograafia [\url{https://en.wikipedia.org/wiki/Public-key_cryptography}]
   \item[] TOML [\url{https://toml.io/en/}]
   \item[] toml\_edit [\url{https://crates.io/crates/toml_edit}]
   \item[] Base64 [\url{https://en.wikipedia.org/wiki/Base64}]
   \item[] SecretKey::generate() [\url{https://docs.rs/iroh/latest/iroh/struct.SecretKey.html#method.generate}]
   \item[] TUN/TAP [\url{https://en.wikipedia.org/wiki/TUN/TAP}]
   \item[] Võrgu virtualiseerimine [\url{https://en.wikipedia.org/wiki/Network_virtualization}]
   \item[] IP [\url{https://en.wikipedia.org/wiki/Internet_Protocol}]
   \item[] tun-rs [\url{https://crates.io/crates/tun-rs/}]
   \item[] AsyncDevice [\url{https://docs.rs/tun-rs/2.8.3/tun_rs/struct.AsyncDevice.html}]
   \item[] async\_framed [\url{https://docs.rs/tun-rs/2.8.3/tun_rs/async_framed/index.html}]
   \item[] Yggdrasili blogipostitus MTU kohta [\url{https://yggdrasil-network.github.io/2018/07/13/about-mtu.html}]
   \item[] Path MTU Discovery [\url{https://en.wikipedia.org/wiki/Path_MTU_Discovery}]
   \item[] net-route [\url{https://crates.io/crates/net-route}]
   \item[] Kanalid [\url{https://en.wikipedia.org/wiki/Channel_(programming)}]
   \item[] tokio::sync::mpsc [\url{https://docs.rs/tokio/latest/tokio/sync/mpsc/index.html}]
   \item[] Reaalajas suhtlussüsteemid [\url{https://en.wikipedia.org/wiki/Real-time_communication}]
   \item[] ring-channel [\url{https://github.com/brunocodutra/ring-channel}]
   \item[] Ringpuhver [\url{https://en.wikipedia.org/wiki/Circular_buffer}]
   \item[] Lock-free [\url{https://en.wikipedia.org/wiki/Non-blocking_algorithm}]
   \item[] etherparse [\url{https://crates.io/crates/etherparse}]
   \item[] std::sync::Mutex [\url{https://doc.rust-lang.org/std/sync/struct.Mutex.html}]
   \item[] std::sync::RwLock [\url{https://doc.rust-lang.org/std/sync/struct.RwLock.html}]
   \item[] arc\_swap [\url{https://docs.rs/arc-swap/latest/arc_swap/}]
   \item[] RFC 4443 [\url{https://datatracker.ietf.org/doc/html/rfc4443#section-3.2}]
   \item[] Get Started [\url{https://rust-lang.org/learn/get-started/}]
   \item[] Rust SDK [\url{https://en.wikipedia.org/wiki/Software_development_kit}]
   \item[] Iroh relays [\url{https://docs.iroh.computer/concepts/relays}]
   \item[] Peer-to-peer [\url{https://en.wikipedia.org/wiki/Peer-to-peer}]
   \item[] Port forwarding [\url{https://en.wikipedia.org/wiki/Port_forwarding}]
   \item[] UPnP [\url{https://en.wikipedia.org/wiki/Universal_Plug_and_Play}]
   \item[] NAT-PMP [\url{https://en.wikipedia.org/wiki/NAT_Port_Mapping_Protocol}]
   \item[] Minecraft [\url{https://en.wikipedia.org/wiki/Minecraft}]
\end{itemize}
